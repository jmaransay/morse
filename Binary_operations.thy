...
next
  ...
  proof
    ...
    hence "(f (simplicial_complex.bool_vec_from_simplice n \<sigma>)) \<or> (g (simplicial_complex.bool_vec_from_simplice n \<sigma>))"
    ...
    thus "\<sigma> \<in> simplicial_complex_induced_by_monotone_boolean_function n f \<union> simplicial_complex_induced_by_monotone_boolean_function n g"
      by auto
  qed
qed
...
lemma eq_inter_and:
  ...
  = simplicial_complex_induced_by_monotone_boolean_function n f \<inter> simplicial_complex_induced_by_monotone_boolean_function n g"
...
next
  ...
  proof
    ...
    hence "bool_fun_and n f g (simplicial_complex.bool_vec_from_simplice n \<sigma>)"
      ...
      unfolding ceros_of_boolean_input_def
      by auto (smt (verit) dim_vec eq_vecI index_vec)+
    hence "(f (simplicial_complex.bool_vec_from_simplice n \<sigma>)) \<and> (g (simplicial_complex.bool_vec_from_simplice n \<sigma>))"
      unfolding bool_fun_and_def
      by auto
    ...
    thus "\<sigma> \<in> simplicial_complex_induced_by_monotone_boolean_function n f \<inter> simplicial_complex_induced_by_monotone_boolean_function n g"
      by auto
  qed
qed

definition bool_fun_ast :: "(nat \<times> nat) \<Rightarrow> (bool vec \<Rightarrow> bool) \<times> (bool vec \<Rightarrow> bool) \<Rightarrow> (bool vec \<times> bool vec \<Rightarrow> bool)"
...
definition
  ...
  where "simplicial_complex_induced_by_monotone_boolean_function_ast n f =
        {z. \<exists>x y. dim_vec x = fst n \<and> dim_vec y = snd n \<and> f (x, y) \<and> ((ceros_of_boolean_input x), (ceros_of_boolean_input y)) = z}"
...
= set_ast (simplicial_complex_induced_by_monotone_boolean_function n (fst f)) (simplicial_complex_induced_by_monotone_boolean_function m (snd f))"
proof
  ...
  proof
    ...
    from sigma and tau have sigtau: "bool_fun_ast (n, m) f ((simplicial_complex.bool_vec_from_simplice n (fst \<gamma>)), (simplicial_complex.bool_vec_from_simplice m (snd \<gamma>)))"
      unfolding bool_fun_ast_def
      by auto
    from sigtau show "\<gamma> \<in> simplicial_complex_induced_by_monotone_boolean_function_ast (n, m) (bool_fun_ast (n, m) f)"
      unfolding simplicial_complex_induced_by_monotone_boolean_function_ast_def
      unfolding bool_fun_ast_def
      using sigma apply auto
...
next
  show "simplicial_complex_induced_by_monotone_boolean_function_ast (n, m)
    ...
    have sigma: "(fst \<gamma>) \<in> simplicial_complex_induced_by_monotone_boolean_function n (fst f)"
      ...
      using ceros_of_boolean_input_def simplicial_complex.bool_vec_from_simplice_def apply fastforce
      using ceros_of_boolean_input_def pert simplicial_complex.bool_vec_from_simplice_def simplicial_complex_induced_by_monotone_boolean_function_ast_def by force
   have tau: "(snd \<gamma>) \<in> simplicial_complex_induced_by_monotone_boolean_function m (snd f)"
      ...
      using ceros_of_boolean_input_def simplicial_complex.bool_vec_from_simplice_def apply fastforce
      using ceros_of_boolean_input_def pert simplicial_complex.bool_vec_from_simplice_def simplicial_complex_induced_by_monotone_boolean_function_ast_def by force
    from sigma and tau show "\<gamma> \<in> set_ast (simplicial_complex_induced_by_monotone_boolean_function n (fst f)) (simplicial_complex_induced_by_monotone_boolean_function m (snd f))"
      using set_ast_def
      by force
  qed
qed
